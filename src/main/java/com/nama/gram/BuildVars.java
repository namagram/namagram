...
public class BuildVars {
    ...
    public static String BUILD_PACKAGENAME= "com.nama.gram";
    ...
    public static String HOCKEY_APP_HASH_DEBUG_SECRET = "";
    public static String GCM_SENDER_ID = "";
    public static String SEND_LOGS_EMAIL = "supertellcontact@gmail.com";
